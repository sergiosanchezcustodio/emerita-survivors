...
export const ENEMIGOS = {
  ...
  serpiente:  { sprite:'serpiente',  rol:'masa',      xp:1, vida:12,    velocidad:18, danyo:2,  radio:4.2,  masa:1.0,  vuela:false, inmuneEmpuje:false, movimiento:'zigzag'    },
  gargola:    { sprite:'gargola',    rol:'masa',      xp:2, vida:22,    velocidad:30, danyo:3,  radio:4.9,  masa:1.2,  vuela:true,  inmuneEmpuje:false, movimiento:'revoloteo' },

  // --- Base: los guardianes humanos ---------------------------------------
  legionario: { sprite:'legionario', rol:'base',      xp:4, vida:55,    velocidad:22, danyo:5,  radio:4.9,  masa:2.4,  vuela:false, inmuneEmpuje:false, movimiento:'directo'   },
  gladiador:  { sprite:'gladiador',  rol:'base',      xp:5, vida:75,    velocidad:44, danyo:6,  radio:5.6,  masa:2.8,  vuela:false, inmuneEmpuje:false, movimiento:'orbita'    },

  // --- Rápido: el único que te alcanza si huyes en línea recta ------------
  arpia:      { sprite:'arpia',      rol:'rapido',    xp:3, vida:34,    velocidad:66, danyo:4,  radio:5.6,  masa:1.6,  vuela:true,  inmuneEmpuje:false, movimiento:'revoloteo' },

  // --- Distancia ----------------------------------------------------------
  medusa:     { sprite:'medusa',     rol:'distancia', xp:5, vida:60,    velocidad:14, danyo:3,  radio:6.3,  masa:2.0,  vuela:false, inmuneEmpuje:false, movimiento:'acecho'    },

  // --- Tanques: cuestan de verdad, y no son jefes -------------------------
  ciclope:    { sprite:'ciclope',    rol:'tanque',    xp:15, vida:220,   velocidad:10, danyo:14, radio:9.8,  masa:8.0,  vuela:false, inmuneEmpuje:true,  movimiento:'directo'   },
  minotauro:  { sprite:'minotauro',  rol:'tanque',    xp:12, vida:170,   velocidad:26, danyo:12, radio:9.1,  masa:7.0,  vuela:false, inmuneEmpuje:false, movimiento:'acecho'    },

  // --- Élite: suelta cofre garantizado ------------------------------------
  manticora:  { sprite:'manticora',  rol:'elite',     xp:60, vida:900,   velocidad:48, danyo:7,  radio:12.6, masa:12.0, vuela:true,  inmuneEmpuje:false, movimiento:'orbita'    },
  ...
  cerbero:    { sprite:'cerbero',    rol:'jefe',      xp:300, vida:5000,  velocidad:30, danyo:18, radio:21,   masa:40.0, vuela:false, inmuneEmpuje:true,  movimiento:'directo'   },
  hidra:      { sprite:'hidra',      rol:'jefe',      xp:800, vida:20000, velocidad:20, danyo:22, radio:27.3, masa:60.0, vuela:false, inmuneEmpuje:true,  movimiento:'directo'   }
};
